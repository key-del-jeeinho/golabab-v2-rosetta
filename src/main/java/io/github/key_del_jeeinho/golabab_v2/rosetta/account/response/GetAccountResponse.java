...
/**
 * GET Method Request 를 통해 계정을 조회할 때, Response Data를 담는 DTO 입니다.
 *
 * @author 지인호
 * @since 1.1.0
 *
 * @param id 조회한 계정의 ID 입니다.
 * @param email 조회한 계정의 이메일 입니다.
 * @param role 조회한 계정의 직책입니다.
 * @param discordId 조회한 계정의 디스코드 아이디 입니다.
 */
